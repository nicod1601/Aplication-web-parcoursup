...
async function downloadExcel() {
	try {
		...
		// Define the specific order of columns to ensure spec_p is never skipped
		const headerOrder = [
			"codecand", "nomcand", "prenomcand", "civilite", "profilcand",
			"nvbourscand", "libfiliere", "libformation", "libspe", "nometab",
			"nomcommu", "codepost", "nomdept", "pays", "idtypedip",
			"libtypedip", "codeseriedip", "libseriedip",
			"spec_t", "spec_p", // These are your aggregated columns
			"noteglobale", "noteficheavenir", "notelycee", "notedossier", "commentaire"
		];
